      ...
      <section className="relative min-h-[50vh] flex items-center overflow-hidden">
        ...
        <div className="container-custom relative z-10 py-20">
          ...
          >
            ...
            >
              Oil <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-300 to-champagne-300">Seeds</span>
            </motion.h1>
            <motion.p
              variants={fadeInUp}
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="w-14 h-14 bg-gradient-to-br from-gold-500 to-gold-600 rounded-2xl flex items-center justify-center mb-6">
