  ...
  return (
    <>
      ...
      <section className="relative min-h-[50vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-br from-amber-900/90 via-yellow-800/85 to-amber-900/90" />
        </div>

        <motion.div
          animate={{ y: [0, -15, 0], rotate: [0, 3, 0] }}
          transition={{ duration: 8, repeat: Infinity }}
          className="absolute top-16 sm:top-20 right-8 sm:right-20 w-40 h-40 sm:w-72 sm:h-72 bg-amber-400/20 rounded-full blur-3xl"
        />
        <motion.div
          animate={{ y: [0, 15, 0], rotate: [0, -3, 0] }}
          transition={{ duration: 10, repeat: Infinity }}
          className="absolute bottom-16 sm:bottom-20 left-8 sm:left-20 w-48 h-48 sm:w-96 sm:h-96 bg-yellow-400/20 rounded-full blur-3xl"
        />
        ...
        <div className="container-custom relative z-10 py-20">
          ...
          >
            ...
            >
              Oil <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 to-yellow-300">Seeds</span>
            </motion.h1>
            <motion.p
              variants={fadeInUp}
              className="text-lg sm:text-xl md:text-2xl text-amber-100 leading-relaxed"
            >
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-yellow-100 rounded-full blur-3xl opacity-50 translate-y-1/2 -translate-x-1/2" />
          ...
          >
            {oilSeeds.map((product, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-amber-600 transition-colors">{product.name}</h3>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Our <span className="text-amber-600">Oil Seeds</span>?
            </h2>
          </motion.div>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-10 py-4 bg-white text-amber-700 font-bold rounded-full hover:bg-amber-50 transition-all duration-300 shadow-lg text-lg"
              >
                Get Quote
