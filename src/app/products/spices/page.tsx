      ...
      <section className="relative min-h-[50vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-br from-orange-900/90 via-red-800/85 to-orange-900/90" />
        </div>

        <motion.div
          animate={{ y: [0, -15, 0], rotate: [0, 3, 0] }}
          transition={{ duration: 8, repeat: Infinity }}
          className="absolute top-16 sm:top-20 right-8 sm:right-20 w-40 h-40 sm:w-72 sm:h-72 bg-orange-400/20 rounded-full blur-3xl"
        />
        <motion.div
          animate={{ y: [0, 15, 0], rotate: [0, -3, 0] }}
          transition={{ duration: 10, repeat: Infinity }}
          className="absolute bottom-16 sm:bottom-20 left-8 sm:left-20 w-48 h-48 sm:w-96 sm:h-96 bg-red-400/20 rounded-full blur-3xl"
        />
        ...
        <div className="container-custom relative z-10 py-20">
          ...
          >
            ...
            >
              Authentic <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-red-300">Spices</span>
            </motion.h1>
            <motion.p
              variants={fadeInUp}
              className="text-lg sm:text-xl md:text-2xl text-orange-100 leading-relaxed"
            >
          ...
          >
            {spices.map((product, index) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="text-lg font-bold text-gray-900 mb-1 group-hover:text-orange-600 transition-colors">{product.name}</h3>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Our <span className="text-orange-600">Spices</span>?
            </h2>
          </motion.div>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-10 py-4 bg-white text-orange-700 font-bold rounded-full hover:bg-orange-50 transition-all duration-300 shadow-lg text-lg"
              >
                Get Quote
